...
export default function DashboardContent() {
  ...
  return (
    <div className="flex min-h-screen bg-surface text-on-surface font-body-md overflow-hidden">
      {/* Sidebar */}
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen max-w-full">
        ...
        {/* Dashboard Body */}
        <main className="p-4 md:p-8 max-w-full mx-auto w-full space-y-6 md:space-y-8 flex-1 overflow-y-auto">
          {isLoading ? (
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full">
            <div className="lg:col-span-8 relative overflow-hidden rounded-2xl bg-[#2b303c] p-4 md:p-8 text-white shadow-xl border border-white/5">
              <div className="relative z-10">
                ...
                <h3 className="text-2xl md:text-3xl font-bold tracking-tight mb-2">Refine Design System Architecture</h3>
              ...
              <svg className="absolute right-0 top-0 h-full w-full object-cover opacity-25 pointer-events-none hidden md:block" viewBox="0 0 800 400" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="lg:col-span-4 flex flex-col gap-8 w-full">
              {/* Mini Calendar */}
              <div className="flex-1 bg-surface-container-lowest border border-outline-variant rounded-2xl p-4 overflow-hidden">
              ...
              {/* Quick Notes */}
              <div className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-4 w-full">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full">
            {/* Activity Timeline */}
            <div className="lg:col-span-8 bg-surface-container-lowest border border-outline-variant rounded-2xl p-4 flex flex-col w-full overflow-hidden">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
                <h4 className="text-lg md:text-xl font-bold text-on-surface">Activity Timeline</h4>
                <div className="flex gap-1 overflow-x-auto pb-2 md:pb-0 hide-scrollbar w-full md:w-auto">
                  ...
                  <div key={item.id} className="flex gap-4 group">
                    ...
                    <div className="pb-6 flex-1 min-w-0">
                      <div className="flex justify-between items-start">
                        <p className="text-sm text-on-surface truncate pr-2">
                        ...
                        <span className="text-xs text-outline whitespace-nowrap shrink-0">{item.time}</span>
                      </div>
                      {item.project && (
                        <p className="text-[10px] text-secondary truncate">{item.project}</p>
                      )}
                      {item.detail && (
                        <div className="mt-2 p-3 bg-[#f3f3fe] border border-outline-variant rounded-lg italic text-sm text-on-surface-variant w-full overflow-hidden text-ellipsis">
                          {item.detail}
                        </div>
                      )}
                    </div>
            ...
            <div className="lg:col-span-4 grid grid-rows-2 gap-8 w-full">
          ...
          <footer className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 pt-4 md:pt-6 border-t border-outline-variant w-full">
            {dashboardStats.map((stat, idx) => (
              <div
                key={idx}
                className="bg-surface-container-lowest border border-outline-variant p-4 rounded-xl hover:shadow-sm transition-shadow min-w-0"
              >
                <div className="flex justify-between items-start">
                ...
                <p className="text-xs font-semibold text-secondary mt-2 truncate">{stat.label}</p>
                <p className="text-xl md:text-2xl font-bold text-on-surface truncate">{stat.val}</p>
              </div>
            ))}
          </footer>
          </>
